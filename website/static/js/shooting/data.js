...
let tekiMaster = [
	...
	new TekiMaster( 1, 10,   100,   100),		// 1. 黄色ひよこ
	new TekiMaster( 2, 70,  5000, 10000),		// 2. ボスひよこ（黄色）
	new TekiMaster( 3, 10,     1,    10),		// 4. ボスひよこ（黄色）の子供
]
...
class SpriteItem{
    constructor( x,y, w,h, type,strong ){
        this.x 		= x;
        this.y 		= y;
        this.w 		= w;
		this.h 		= h;
...
const ITEM_RECOVER    = 0;    // 回復させる
const ITEM_MUTEKI     = 1;    // 無敵状態になる
const ITEM_ATTACK     = 4;    // 自分の弾の強さをあげる

let itemSprite = [
	new SpriteItem(  2, 14, 1,1, ITEM_RECOVER,10 ),	//0. 回復１
	new SpriteItem(  7,  14, 1,1, ITEM_RECOVER,30 ),	//1. 回復２
	new SpriteItem(  10, 16, 1,1, ITEM_MUTEKI,10 ),	//2. 盾（無敵）
	new SpriteItem(  15,  18, 1,1, ITEM_ATTACK,10 ),	//3. 攻撃強化
]

let marioSprite = [
	new Sprite(208,208,16,16),	//0. スター1
	new Sprite(208,208,16,16),	//1. スター2
	new Sprite(208,208,16,16),	//2. スター3
	new Sprite(16,16,16,16),
